Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/thunder/3.10.1/thunder.zip" }
...
full.dependency 'jobase/jobase', '3.10.1'
full.dependency 'libvpx', '1.0.3'
full.dependency 'libyuv', '1.0.2'
full.dependency 'transengine/transengine-full', '3.10.0'
full.dependency 'yyaudiosdk', '3.10.0'
full.dependency 'yydec265', '1.0.12'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '3.7.4'
...
fullai.dependency 'jobase/jobase', '3.10.1'
fullai.dependency 'libvpx', '1.0.3'
fullai.dependency 'libyuv', '1.0.2'
fullai.dependency 'tnn/tnn_core', '1.0.8'
fullai.dependency 'tnn/vfi', '1.0.8'
fullai.dependency 'transengine/transengine-full', '3.10.0'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.10.0'
fullai.dependency 'yydec265', '1.0.12'
fullai.dependency 'yyvideolib/yyvideolibstaticai_nobeauty', '3.7.4'
...
videoai.dependency 'jobase/jobase', '3.10.1'
videoai.dependency 'libvpx', '1.0.3'
videoai.dependency 'libyuv', '1.0.2'
videoai.dependency 'tnn/tnn_core', '1.0.8'
videoai.dependency 'tnn/vfi', '1.0.8'
videoai.dependency 'transengine/transengine-full', '3.10.0'
videoai.dependency 'yyaudiosdk', '3.10.0'
videoai.dependency 'yydec265', '1.0.12'
videoai.dependency 'yyvideolib/yyvideolibstaticai_nobeauty', '3.7.4'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'jobase/jobase', '3.10.1'
audio.dependency 'transengine/transengine-audio', '3.10.0'
audio.dependency 'yyaudiosdk', '3.10.0'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'jobase/jobase', '3.10.1'
audioai.dependency 'transengine/transengine-audio', '3.10.0'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.10.0'
