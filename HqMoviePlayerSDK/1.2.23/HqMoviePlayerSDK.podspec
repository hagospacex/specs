Pod::Spec.new do |s|
        ...
        s.source                = {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/HqMoviePlayerSDK/1.2.23/HqMoviePlayerSDK.zip"}
        s.platform              = :ios, "9.0"
        s.requires_arc  = true

        s.frameworks = 'CoreGraphics' ,'UIKit','Foundation','AVKit','AVFoundation','AVFAudio'
        
	s.libraries = 'HqMoviePlayerSDK', 'z', 'resolv' , 'c++', 'xml2'
