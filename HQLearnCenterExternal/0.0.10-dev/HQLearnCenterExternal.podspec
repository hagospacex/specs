Pod::Spec.new do |s|
   ...
   s.source                = {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/HQLearnCenterExternal/0.0.10-dev/HQLearnCenterExternal.zip"}
   s.platform              = :ios, "9.0"
   s.requires_arc  = true
...
s.dependency 'HqMoviePlayerSDK', '~>1.2.20'
