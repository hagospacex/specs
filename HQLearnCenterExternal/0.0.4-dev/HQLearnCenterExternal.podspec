Pod::Spec.new do |s|
   ...
   s.source                = {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/HQLearnCenterExternal/0.0.4-dev/HQLearnCenterExternal.zip"}
   s.platform              = :ios, "9.0"
   s.requires_arc  = true
...
s.dependency 'HqAppArchitect', '0.1.10'
s.dependency 'HqEbookViewSDK', '~>3.0.2'
s.dependency 'HqMoviePlayerSDK', '1.2.16'
