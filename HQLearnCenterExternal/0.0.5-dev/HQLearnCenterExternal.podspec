Pod::Spec.new do |s|
   ...
   s.source                = {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/HQLearnCenterExternal/0.0.5-dev/HQLearnCenterExternal.zip"}
   s.platform              = :ios, "9.0"
   s.requires_arc  = true
