Pod::Spec.new do |s|
	...
	s.source 		= {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/hqwxedu/2.9.0/hqwxedu.zip"}
...
s.dependency 'hqwxclassing', '1.5.0'
s.dependency 'hqwxclassroom', '~> 1.2.0'
s.dependency 'hqwxinteractive', '1.4.2'
