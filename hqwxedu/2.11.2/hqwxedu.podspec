Pod::Spec.new do |s|
	...
	s.source 		= {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/hqwxedu/2.11.2/hqwxedu.zip"}
...
s.dependency 'TXLiteAVSDK_TRTC', '10.7.11936'
s.dependency 'YYText', '~> 1.0.0'
s.dependency 'hqimsdk', '~> 1.7.0'
s.dependency 'hqwxbase', '1.0.7'
s.dependency 'hqwxclassing', '1.6.1'
s.dependency 'hqwxclassroom', '~> 1.2.0'
s.dependency 'hqwxinteractive', '1.5.0'
s.dependency 'hqwxmetrics', '~>1.0.6'
s.dependency 'hqwxsignalling', '~> 1.0.7'
s.dependency 'hqwxwhiteboard', '1.2.0'
