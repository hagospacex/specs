Pod::Spec.new do |s|
	...
	s.source 		= {:http => "http://yyci2020.oss-cn-shenzhen.aliyuncs.com/yyqapm/ios/hqimsdk/1.7.1/hqimsdk.zip"}
	s.source_files	= 'include/**/*.{h,hpp}'
	s.preserve_paths = 'libs/*.a'

	s.frameworks = 'SystemConfiguration' ,'Photos','CoreTelephony','AVFoundation'
